...
#ifndef MIDIALF_UI_PAGES_INIT_PAGE_H_
#define MIDIALF_UI_PAGES_INIT_PAGE_H_
...
class InitPage : public UiPage {
 ...
 protected:
  ...
  DISALLOW_COPY_AND_ASSIGN(InitPage);
};

} // namespace midialf

#endif  // MIDIALF_UI_PAGES_INIT_PAGE_H_
