...
#ifndef MIDIALF_UI_PAGES_SAVE_PAGE_H_
#define MIDIALF_UI_PAGES_SAVE_PAGE_H_
...
class SavePage : public UiPage {
 ...
 protected:
  ...
  static uint8_t edit_offset_;
  static uint8_t original_char_;
  static UiPageIndex prev_page_;

  static void SetSlot(uint8_t slot);
  static void SaveSlot();

  DISALLOW_COPY_AND_ASSIGN(SavePage);
};

} // namespace midialf

#endif  // MIDIALF_UI_PAGES_SAVE_PAGE_H_
