...
#ifndef MIDIALF_CLOCK_H_
#define MIDIALF_CLOCK_H_
...
static const uint8_t kNumGrooveTemplates = 6;

static const uint8_t kMinBpm = 25;
static const uint8_t kMaxBpm = 250;
