...
#ifndef MIDIALF_UI_PAGES_CC2_PAGE_H_
#define MIDIALF_UI_PAGES_CC2_PAGE_H_

#include "midialf/ui_pages/ui_page.h"

namespace midialf {

class CC2Page : public UiPage {
 public:
  CC2Page() { }
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(CC2Page);
};

} // namespace midialf

#endif  // MIDIALF_UI_PAGES_CC2_PAGE_H_
