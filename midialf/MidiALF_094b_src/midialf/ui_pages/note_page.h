...
#ifndef MIDIALF_UI_PAGES_NOTE_PAGE_H_
#define MIDIALF_UI_PAGES_NOTE_PAGE_H_

#include "midialf/ui_pages/ui_page.h"

namespace midialf {

class NotePage : public UiPage {
 public:
  NotePage() { }
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(NotePage);
};

} // namespace midialf

#endif  // MIDIALF_UI_PAGES_NOTE_PAGE_H_
