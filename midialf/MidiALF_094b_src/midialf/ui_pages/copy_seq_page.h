...
#ifndef MIDIALF_UI_PAGES_COPY_SEQ_PAGE_H_
#define MIDIALF_UI_PAGES_COPY_SEQ_PAGE_H_

#include "midialf/ui_pages/ui_page.h"

namespace midialf {

class CopySeqPage : public UiPage {
 public:
  CopySeqPage() { }
 ...
 protected:
  static uint32_t started_time_;
   ...
   DISALLOW_COPY_AND_ASSIGN(CopySeqPage);
};

} // namespace midialf

#endif  // MIDIALF_UI_PAGES_COPY_SEQ_PAGE_H_
