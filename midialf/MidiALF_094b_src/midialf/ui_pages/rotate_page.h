...
#ifndef MIDIALF_UI_PAGES_ROTATE_PAGE_H_
#define MIDIALF_UI_PAGES_ROTATE_PAGE_H_

#include "midialf/ui_pages/ui_page.h"

namespace midialf {

class RotatePage : public UiPage {
 public:
  RotatePage() { }
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(RotatePage);
};

} // namespace midialf

#endif  // MIDIALF_UI_PAGES_ROTATE_PAGE_H_
