...
#ifndef MIDIALF_UI_PAGES_CC1_PAGE_H_
#define MIDIALF_UI_PAGES_CC1_PAGE_H_

#include "midialf/ui_pages/ui_page.h"

namespace midialf {

class CC1Page : public UiPage {
 public:
  CC1Page() { }
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(CC1Page);
};

} // namespace midialf

#endif  // MIDIALF_UI_PAGES_CC1_PAGE_H_
